...
////индексы вершин для соединения вершин в грани
...
//};
//
////из входного вектора вершин, которые повторяются, делает два выходных вектора: в первом неповторяющиеся вершины, 
...
//}
//
////образует вектор вершин, в порядке очередности индексов вершин треугольников для граней
...
//		if (firstSymbol == "v") //координаты вершин
//		{
//			glm::vec3 vertex;
...
//		}
//		else if (firstSymbol == "f")//Определения поверхности сторон
//		{
...
//	read_obj("vase.obj", vertices);
//	indexVBO(vertices, indices, indexed_vertices);
//	rand_color(indexed_vertices.size());
//}
//
